...
const REDIRECT_URLS = [
  'https://jbanmo.com/',
  'https://jbescorts.org/',
  'https://jbescortservices.com/',
  'https://jbxiashui.com/',
  'https://wishctjb.com/',
  'https://jbwishcity.com/',
  'https://t.me/JBanmowang',
  'https://t.me/JBjinhaiwan',
  'https://chat.whatsapp.com/C9MF4hgw6Xa9jq8yH8VppN',
  'https://chat.whatsapp.com/DyKTWDZMSpV7Gjn41Fze8x',
]

export const metadata: Metadata = {
  title: 'JB Escort Platforms — 新山伴游平台导航 | jbescorts.org',
  description: '新山伴游平台聚合导航，汇集新山所有优质伴游网站，一站直达。',
  alternates: { canonical: '/platforms' },
  openGraph: {
    title: 'JB Escort Platforms — 新山伴游平台导航',
    description: '新山伴游平台聚合导航，一站直达所有优质平台。',
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 -mt-8 relative z-20">
        <h2 className="text-xl md:text-2xl font-extrabold text-gray-900 mb-3">
          Explore 16 Verified Escort Platforms in Johor Bahru
        </h2>
        <p className="text-gray-600 text-sm leading-relaxed mb-2">
          jbescorts.org brings together the most popular escort platforms around Jalan Dhoby and greater Johor Bahru. Browse our curated list and visit the platform that fits you best.
        </p>
        <p className="text-gray-500 text-xs leading-relaxed mb-6">
          jbescorts.org 汇集了新山 Jalan Dhoby 及周边地区最受欢迎的伴游平台，点击卡片直接访问。
        </p>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {platforms.map((site, index) => {
            ...
            const redirectUrl = REDIRECT_URLS[index % REDIRECT_URLS.length]
            return (
              <a
                key={site.slug}
                href={redirectUrl}
