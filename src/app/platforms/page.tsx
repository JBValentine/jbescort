    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <header className="relative bg-gray-900 py-8 lg:py-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <p className="text-xs md:text-sm text-gray-400 max-w-2xl mb-6">
            新山伴游平台聚合导航 �?汇集优质平台，覆�?Jalan Dhoby 及全城�?
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 -mt-8 relative z-20">
        ...
        <p className="text-gray-500 text-xs leading-relaxed mb-6">
          jbescorts.org 汇集了新�?Jalan Dhoby 及周边地区最受欢迎的伴游平台。无需逐个搜索，在这里浏览精选列表、阅读简介，直接访问适合你的平台�?
        </p>
      </section>
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl border border-red-100 p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { rule: 'Rule 2 规则�?, title: 'Verify photos are real 核实照片真实�?, desc: '预约前要求实时自拍或视频通话，假照片是最常见的手段�? },
              { rule: 'Rule 3 规则�?, title: 'Use platforms listed here 使用本站收录平台', desc: '优先使用 jbescorts.org 收录的平台，随机社交媒体联系人风险极高�? },
              { rule: 'Rule 4 规则�?, title: 'Meet in safe locations 选择安全地点', desc: '务必在新山知名酒店或 Jalan Dhoby 附近正规场所见面，避免陌生私人地址�? },
            ].map((item) => (
