...
export const metadata: Metadata = {
  title: 'JB 自由身 Freelance — 新山下水按摩导航 | jbescorts.org',
  description: `新山自由身下水 & 按摩导航 — ${freelancerData.totalCount}+ 真实资料，覆盖 ${freelancerData.areas.length} 个区域。Johor Bahru freelance escort & massage directory.`,
  alternates: { canonical: '/freelance' },
  openGraph: {
    title: 'JB 自由身 Freelance — 新山下水按摩导航',
      ...
      <header className="bg-gray-900 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2">
            JB 自由身 <span className="text-blue-400">Freelance</span>
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto mb-4">
            新山自由身下水 & 按摩导航 — 真实资料，覆盖 {areas.length} 个区域
          </p>
